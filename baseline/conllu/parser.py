...
DEFAULT_FIELDS = ('id', 'form', 'lemma', 'upostag', 'xpostag', 'feats', 'head', 'deprel', 'deps', 'misc','PARSEME:MWE') # Modifier afin de prendre en compte le fait que ce soit une expression ou non, en ajouteant le champ YOLO
